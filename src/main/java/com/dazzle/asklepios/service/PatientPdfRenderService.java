...
public class PatientPdfRenderService {
    ...
    public byte[] generatePatientLabelPdf(Long patientId, String lang, Integer copies) {
        ...
        context.setVariable("labels", buildPatientLabelLabels(isArabic));
    ...
    private Map<String, String> buildCommonPatientLabels(boolean isArabic) {
    ...
    private Map<String, String> buildPatientLabelLabels(boolean isArabic) {
        Map<String, String> labels = buildCommonPatientLabels(isArabic);

        labels.put("patientLabel", isArabic ? "ملصق المريض" : "Patient Label");
